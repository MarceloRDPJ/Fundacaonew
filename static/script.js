...
function getAnswerFromAI(question) {
    ...
    fetch('/ask', {
        ...
        body: JSON.stringify({ question: question, context: null }) // Contexto não é mais necessário aqui
    })
    .then(response => response.json())
    .then(data => {
        const answerText = data.answer;
        // As chaves 'context' e 'follow_up' não existem mais, a IA gerencia a conversa
